...
const suggestionList = document.querySelector(".suggestion") as HTMLUListElement;
const movieResults = document.querySelector(".movie-results") as HTMLDivElement;
...
async function fetchMovieById(id: string): Promise<void> {
    const API_KEY = "f6ab01ff";
